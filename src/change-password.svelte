...
<div bind:this={modal} uk-modal>
    <div class="uk-modal-dialog uk-modal-body">
        ...
        {#if database.isPasswordSetupNeeded}
            <p>Скорее всего ты открыл эту ссылку в первый раз. Тебе нужно придумать пароль и хорошо его запомнить. Если пароль забудешь, восстановить доступ не получится.</p>
        {/if}
